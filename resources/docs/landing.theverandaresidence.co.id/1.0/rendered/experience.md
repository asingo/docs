...
Section Experience merupakan section yang digunakan sebagai deskripsi pengalaman ketika menginap di Veranda
...
Setelah klik poin ke dua dari gambar diatas maka akan muncul gambar seperti di bawah ini

 ![](http://docs.grapiku.com/storage/landing-veranda/experience/Experience-Single.jpg)Nomor yang ada gambar di atas merepresentasikan elemen yang ada pada gambar di bawah ini
...
Untuk mengganti Background Image yang ada pada section ini (nomor 3), silahkan klik tombol pensil yang ditandai dengan nomor di bawah ini

 ![](http://docs.grapiku.com/storage/landing-veranda/experience/Experience-Single-Edit.jpg)Setelah klik tombol pensil yang ditunjukkan elemen di atas, akan muncul gambar di bawah ini
...
Setelah perubahan selesai silahkan klik tombol PERBARUI atau TERBITKAN untuk menyimpan perubahan.